...
export class Traffic_Light{
    ...
    constructor(pointsPath){
        this.poleMaterial = new THREE.MeshPhysicalMaterial( {
            color: 0x333332, metalness: 0.6, roughness: 0.4, clearcoat: 0.05, clearcoatRoughness: 0.05
        } );
        ...
        this.glassMaterial = new THREE.MeshPhysicalMaterial( {
            color: 0xffffff, metalness: .4, roughness: 0.1, transmission: 0.5, transparent: true,clearcoat:1
        } );
...
Traffic_Light.prototype.loadModel = async function(loader,resolve){
